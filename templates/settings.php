<form id="user_shibboleth" action="#" method="post">
	<fieldset class="personalblock">
		...
		<label for="ldap_uuid_attribute"><?php p($l->t('LDAP UUID Attribute'));?>:</label><input type="text" id="ldap_uuid_attribute" name="ldap_uuid_attribute" value="<?php p($_['ldap_uuid_attribute']); ?>" title="<?php p($l->t('Attribute used to create the UUID for a user'));?>"><br/>
